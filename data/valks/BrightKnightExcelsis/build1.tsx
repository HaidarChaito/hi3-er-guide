...
import BrightKnightExcelsis from './valk';
import { Bright_Knight_Excelsis_Ego } from '@/data/signets/tsx/EgoSignets';
...
const build1: Build = {
  ...
  signets: [
    ...
    [
      ...
      withPriority(Bright_Knight_Excelsis_Ego.Blessing_of_Glory, 'F2 Ego'),
    ],
