...
const build2: BuildType = {
  ...
  isNew: true,
  notes: 'Disclaimer this build feels janky is extremely weaker than the other, although looking braindead, this build needs to pay attention to the time fracture as it can be easily mistimed, ruining the SEQ 4 connect; Take BKE if you find yourself struggling with Heimdal',
  signets: [
[
