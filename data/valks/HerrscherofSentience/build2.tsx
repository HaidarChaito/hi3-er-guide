...
const build2: Build = {
  ...
  notes:
    'Prioritize getting SP Regen signets ASAP or otherwise get Dark Plumes at F5 or any other point in the run. Swap BR for BK by F9/F10 Shop to deal with Heimdall.',
  signets: [
    [
