...
const build2: Build = {
    ...
    tier: 5,
    isNew: true,
    notes: 'Swap BR for BK by F9/F10 Shop to deal with Heimdall. This build focus on using charged attacks, similiarly to the weapon active build, your absolute evasion stacks will be consumed to refresh your glitter bar for more charged attacks to deal very heavy damage.',
    signets: [
        [
