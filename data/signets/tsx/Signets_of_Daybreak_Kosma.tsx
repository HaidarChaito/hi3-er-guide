...
Undetermined_Judgement_sic : { label:'Undetermined Judgement [sic]',description: "Restores 5 SP when Evils Doom hits a shield-broken or unshielded enemy. CD: 5s. The Valkyrie also gains 40% more Physical and Elemental DMG for 10s." ,family: 'Signets of Daybreak (Kosma)',},
...
Daybreak_Lone_BeaconCore : { label:'Daybreak, Lone BeaconCore',description: "Rend will also be applied to Valkyrie. Each stack of Rend makes Valkyrie deal 2% more Total DMG, increases max HP by 30, and lose 2 HP per second down to 1 HP.This signet cannot be upgraded." ,family: 'Signets of Daybreak (Kosma)',},
