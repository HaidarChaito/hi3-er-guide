...
image_folder = "images/avatars"
class_name = "AvatarImages"
export_file = f"../../data/supports/{class_name}.g.tsx"

# Get a list of all image files in the folder
image_files = [file for file in os.listdir(f"../../public/{image_folder}") if file.endswith(".png")]
...
for file_name in image_files:
    variable_name = file_name.replace('.png','').replace(".", "_").replace("-", "_").replace(" ", "_").split(".")[0]
